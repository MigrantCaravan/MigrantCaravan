...
##### Last Projects
- 🤖 [Poor's Man Truora](https://github.com/MigrantCaravan/poors-man-truora). Identity verification app that uses `TensorFlow.js` and the `BlazeFace` to detect faces;
